    ...
    fun loadPaymentView(view: View) {
        ...
        when {
            ...
            !genesis?.isValidData!! -> {
                ...
                val technicalMessage: String = when {
                    error!!.technicalMessage != null && error!!.technicalMessage?.isNotEmpty()!! -> error!!.technicalMessage!!
                    else -> ""
                }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        when (requestCode) {
            Activity.RESULT_FIRST_USER -> {
                ...
                when (resultCode) {
                    Activity.RESULT_OK -> {
                        val technicalMessage = data!!.getStringExtra(IntentExtras.EXTRA_RESULT)
                        when {
                            technicalMessage != null -> {
                                ...
                                dialogHandler = AlertDialogHandler(this, "Success",
                                        "Success")
                                dialogHandler!!.show()
                            }
                        }
